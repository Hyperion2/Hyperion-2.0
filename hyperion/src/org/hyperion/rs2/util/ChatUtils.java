	...
	public static int encryptPlayerChat(byte[] is, int i_25_, int i_26_,
		...
		try {
			...
			for (; i_27_ > i_25_; i_25_++) {
				final int i_31_ = 0xff & is_28_[i_25_];
				final int i_32_ = anIntArray233[i_31_];
				final int i_33_ = aByteArray235[i_31_];
				int i_34_ = i_30_ >> -1445887805;
				int i_35_ = i_30_ & 0x7;
				i_29_ &= -i_35_ >> 473515839;
				i_30_ += i_33_;
				final int i_36_ = (-1 + i_35_ - -i_33_ >> -1430991229) + i_34_;
				i_35_ += 24;
